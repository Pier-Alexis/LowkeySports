    ...
    return (
        <footer className="footer">
            <div className="container">
                <p>
                    Lowkey<span className="text-gold">Sports</span> — prédictions sportives et analyses.
                </p>
                <div className="footer-links">
                    <a
                        href="https://discord.gg/drudT9UvV"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="footer-discord"
                        aria-label="Rejoindre le serveur Discord LowkeySports"
                        title="Rejoins-nous sur Discord"
                    >
                        <svg viewBox="0 0 127.14 96.36" width="24" height="24" aria-hidden="true" focusable="false">
                            <path
                                fill="currentColor"
                ...
                <p className="footer-note">
                    Les prédictions sont des avis personnels et ne constituent pas un conseil. Aucun pari n'est proposé.
                </p>
            </div>
        </footer>
    );
